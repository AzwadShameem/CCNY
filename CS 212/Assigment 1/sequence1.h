...
//     Postcondition: The sequence has been initialized as an empty sequence,
        // which is a static array. (Please do not use dynamic variables.
        //     You can also use vector instead of array if you want.)
//
